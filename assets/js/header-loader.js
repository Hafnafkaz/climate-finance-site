...
(function() {
  ...
  fetch(baseUrl + 'assets/inc/header.html?v=' + Date.now(), { cache: 'no-store' })
    ...
    .then(function(html) {
      ...
      var map = {
        ...
        'loan-program': ['impact'],
        'acf-working-groups': ['impact'],
        'renewable-energy': ['impact'],
        'sunshine-stories': ['impact'],
        'centering-people': ['impact'],
        contact: ['contact'],
        donate: ['donate'],
        faq: ['faq'],
        'what-we-do': ['services'],
